...
public class Array{
	...
	public static void main(String [] args){
		...
		System.out.println(array.linearSearch(5)); //check 40 is present in the array using linearSearch.

		array.bubbleSort();//sort the array.
		array.display();   //display the array.

		System.out.println(array.binarySearch(5,0,size)); //search for num=56 using Binary Search.
	}
}